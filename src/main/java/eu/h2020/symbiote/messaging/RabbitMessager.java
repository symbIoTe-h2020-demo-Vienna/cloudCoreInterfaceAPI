...
public class RabbitMessager {
     ...
     * @throws Exception
     */
    public static void sendMessage(String queueName, String object) throws Exception {
...
//        String message = objectInJson;
        //object already in String

        channel.basicPublish("", queueName, null, object.getBytes("UTF-8"));
